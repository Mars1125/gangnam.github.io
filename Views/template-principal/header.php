...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        ...
        <img src="<?php echo BASE_URL . 'assets/img/brand.png' ?>" alt="image" class=" navbar-brand" width="250">      
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between"
                ...
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo BASE_URL . 'principal/acerca' ?>">ACERCA DE</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo BASE_URL . 'principal/about' ?>">IDENTIDAD</a>
                        </li>
                    </ul>
                </div>
                <div class="navbar align-self-center d-flex">
                    ...
                    <?php if (!empty($_SESSION['correoCliente'])) { ?>
                        <a class="nav-icon position-relative text-decoration-none" href="<?php echo BASE_URL . 'clientes' ?>">
                            <img src="<?php echo BASE_URL . 'assets/img/default.png' ?>" class="img-thumbnail" alt="..."
                                width="36">
                        </a>
                    <?php } else { ?>
