...
class Clientes extends Controller
{
    ...
    {
        if (isset($_POST['nombre']) && ($_POST['clave']) && ($_POST['correo'])) {
    ...
    public function enviarCorreo()
    {
        if (isset($_POST['correo']) && isset($_POST['token'])) {
            ...
            try {
                ...
                //Recipients
                $mail->setFrom('marsanchezc1125@gmail.com', 'Marina Sanchez');
                $mail->addAddress($_POST['correo']); //Add a recipient

                //Content
                $mail->isHTML(true); //Set email format to HTML
                $mail->Subject = 'Mensaje de prueba';
                $mail->Body = 'Para verificar tu correo da click en el siguiente enlace<a href="' . BASE_URL . 'clientes/verificarCorreo/' . $_POST['token'] . '">Da click aqui</a>';
    ...
    {
        if (isset($_POST['correoLogin']) && ($_POST['claveLogin'])) {
